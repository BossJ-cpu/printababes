...
class SubmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Sync to ERP - Send to PRINTABLESTEST DocType
        // Only send required field (title) and optional details
        $this->erp->createGenericRecord('PRINTABLESTEST', [
            'title' => $submission->name,
            'details' => "Email: {$submission->email}, Age: {$submission->age}"
        ]);
