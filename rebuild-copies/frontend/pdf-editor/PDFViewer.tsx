        ...
        {Array.from(new Array(numPages), (_, index) => {
          ...
          return (
            ...
            >
              ...
              {hoverCoords && (
                <div
                  className="absolute pointer-events-none bg-black text-white text-xs px-2 py-1 rounded z-50"
                  style={{
              ...
              {/* Existing Field Markers */}
              {template &&
                Object.entries(template.fields_config).map(([key, conf]) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        left: (conf.x / 210) * 100 + '%',
                        bottom: `calc(100% - ${(conf.y / 297) * 100}%)`,
